...
func TestG2AffineIsOnCurve(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	genFuzz1 := GenFp()
	properties.Property("[BW6-764] g2Gen (affine) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
	...
	properties.Property("[BW6-764] g2Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
...
func TestG2AffineConversions(t *testing.T) {
	...
	properties.Property("[BW6-764] Affine representation should be independent of the Jacobian representative", prop.ForAll(
		func(a fp.Element) bool {
	...
	properties.Property("[BW6-764] Affine representation should be independent of a Extended Jacobian representative", prop.ForAll(
		func(a fp.Element) bool {
			var g g2JacExtended
			g.X.Set(&g2Gen.X)
			g.Y.Set(&g2Gen.Y)
	...
	properties.Property("[BW6-764] Jacobian representation should be the same as the affine representative", prop.ForAll(
		func(a fp.Element) bool {
			var g G2Jac
			var op1 G2Affine
			op1.X.Set(&g2Gen.X)
	...
	properties.Property("[BW6-764] Converting affine symbol for infinity to Jacobian should output correct infinity in Jacobian", prop.ForAll(
		func() bool {
			var g G2Affine
			g.X.SetZero()
			g.Y.SetZero()
	...
	properties.Property("[BW6-764] Converting infinity in extended Jacobian to affine should output infinity symbol in Affine", prop.ForAll(
		func() bool {
			var g G2Affine
	...
	properties.Property("[BW6-764] Converting infinity in extended Jacobian to Jacobian should output infinity in Jacobian", prop.ForAll(
		func() bool {
			var g G2Jac
			var op1 g2JacExtended
	...
	properties.Property("[BW6-764] [Jacobian] Two representatives of the same class should be equal", prop.ForAll(
...
func TestG2AffineOps(t *testing.T) {
	...
	properties.Property("[BW6-764] [Jacobian] Add should call double when having adding the same point", prop.ForAll(
		func(a, b fp.Element) bool {
	...
	properties.Property("[BW6-764] [Jacobian] Adding the opposite of a point to itself should output inf", prop.ForAll(
		func(a, b fp.Element) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
			fop2 := fuzzJacobianG2Affine(&g2Gen, b)
			fop2.Neg(&fop2)
	...
	properties.Property("[BW6-764] [Jacobian] Adding the inf to a point should not modify the point", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
	...
	properties.Property("[BW6-764] [Jacobian Extended] addMixed (-G) should equal subMixed(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
	...
	properties.Property("[BW6-764] [Jacobian Extended] doubleMixed (-G) should equal doubleNegMixed(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
			var p1, p1Neg G2Affine
			p1.FromJacobian(&fop1)
	...
	properties.Property("[BW6-764] [Jacobian] Addmix the negation to itself should output 0", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG2Affine(&g2Gen, a)
			fop1.Neg(&fop1)
			var op2 G2Affine
	...
	properties.Property("[BW6-764] scalar multiplication (double and add) should depend only on the scalar mod r", prop.ForAll(
	...
	properties.Property("[BW6-764] scalar multiplication (GLV) should depend only on the scalar mod r", prop.ForAll(
		func(s fr.Element) bool {
	...
	properties.Property("[BW6-764] GLV and Double and Add should output the same result", prop.ForAll(
		func(s fr.Element) bool {
...
func TestG2AffineCofactorCleaning(t *testing.T) {
	...
	properties.Property("[BW6-764] Clearing the cofactor of a random point should set it in the r-torsion", prop.ForAll(
		func() bool {
...
func TestG2AffineBatchScalarMultiplication(t *testing.T) {
	...
	properties.Property("[BW6-764] BatchScalarMultiplication should be consistant with individual scalar multiplications", prop.ForAll(
