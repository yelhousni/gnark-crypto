...
TEXT ·sub(SB), NOSPLIT, $0-24
	...
	SBBQ 88(R14), R13
	JCC  l1
	MOVQ $0xf870000000000085, R15
	ADDQ R15, AX
	MOVQ $0x5dd86710000000ab, R15
	ADCQ R15, DX
	MOVQ $0x63c2f132d6400058, R15
	ADCQ R15, CX
	MOVQ $0xc47c22f24fbf3b3e, R15
	ADCQ R15, BX
	MOVQ $0xe4d8b84d76f9ef9e, R15
	ADCQ R15, SI
	MOVQ $0x5d84ff875d577945, R15
	ADCQ R15, DI
	MOVQ $0x2f12a8f4577b6283, R15
	ADCQ R15, R8
	MOVQ $0xa904786c4f97be0e, R15
	ADCQ R15, R9
	MOVQ $0xec6ee87d3b4d1280, R15
	ADCQ R15, R10
	MOVQ $0xdb11f4639db77f4f, R15
	ADCQ R15, R11
	MOVQ $0xa1ba736fcc2d419d, R15
	ADCQ R15, R12
	MOVQ $0x0b445f0691766d95, R15
	ADCQ R15, R13
...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	TESTQ AX, AX
	JEQ   l2
	MOVQ  $0xf870000000000085, AX
	SUBQ  DX, AX
	MOVQ  AX, 0(R15)
	MOVQ  $0x5dd86710000000ab, AX
	SBBQ  CX, AX
	MOVQ  AX, 8(R15)
	MOVQ  $0x63c2f132d6400058, AX
	SBBQ  BX, AX
	MOVQ  AX, 16(R15)
	MOVQ  $0xc47c22f24fbf3b3e, AX
	SBBQ  SI, AX
	MOVQ  AX, 24(R15)
	MOVQ  $0xe4d8b84d76f9ef9e, AX
	SBBQ  DI, AX
	MOVQ  AX, 32(R15)
	MOVQ  $0x5d84ff875d577945, AX
	SBBQ  R8, AX
	MOVQ  AX, 40(R15)
	MOVQ  $0x2f12a8f4577b6283, AX
	SBBQ  R9, AX
	MOVQ  AX, 48(R15)
	MOVQ  $0xa904786c4f97be0e, AX
	SBBQ  R10, AX
	MOVQ  AX, 56(R15)
	MOVQ  $0xec6ee87d3b4d1280, AX
	SBBQ  R11, AX
	MOVQ  AX, 64(R15)
	MOVQ  $0xdb11f4639db77f4f, AX
	SBBQ  R12, AX
	MOVQ  AX, 72(R15)
	MOVQ  $0xa1ba736fcc2d419d, AX
	SBBQ  R13, AX
	MOVQ  AX, 80(R15)
	MOVQ  $0x0b445f0691766d95, AX
	SBBQ  R14, AX
	MOVQ  AX, 88(R15)
	RET
