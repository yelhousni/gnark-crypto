...
func TestG1AffineIsOnCurve(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	genFuzz1 := GenFp()
	properties.Property("[BW6-764] g1Gen (affine) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
	...
	properties.Property("[BW6-764] g1Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
