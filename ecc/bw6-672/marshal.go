...
// Encoder writes bw6-672 object values to an output stream
type Encoder struct {
	w   io.Writer
...
// Decoder reads bw6-672 object values from an inbound stream
type Decoder struct {
	r io.Reader
	n int64 // read bytes
}

// NewDecoder returns a binary decoder supporting curve bw6-672 objects in both
...
func (dec *Decoder) Decode(v interface{}) (err error) {
	...
	if rv.Kind() != reflect.Ptr || rv.IsNil() || !rv.Elem().CanSet() {
		return errors.New("bw6-672 decoder: unsupported type, need pointer")
	}
	...
	default:
		n := binary.Size(t)
		if n == -1 {
			return errors.New("bw6-672 encoder: unsupported type")
		}
...
// NewEncoder returns a binary encoder supporting curve bw6-672 objects
...
const SizeOfG1AffineCompressed = 88
...
func (p *G1Affine) Bytes() (res [SizeOfG1AffineCompressed]byte) {
	...
	tmp = p.X
	tmp.FromMont()
	binary.BigEndian.PutUint64(res[80:88], tmp[0])
	binary.BigEndian.PutUint64(res[72:80], tmp[1])
	binary.BigEndian.PutUint64(res[64:72], tmp[2])
	binary.BigEndian.PutUint64(res[56:64], tmp[3])
	binary.BigEndian.PutUint64(res[48:56], tmp[4])
	binary.BigEndian.PutUint64(res[40:48], tmp[5])
	binary.BigEndian.PutUint64(res[32:40], tmp[6])
	binary.BigEndian.PutUint64(res[24:32], tmp[7])
	binary.BigEndian.PutUint64(res[16:24], tmp[8])
	binary.BigEndian.PutUint64(res[8:16], tmp[9])
	binary.BigEndian.PutUint64(res[0:8], tmp[10])
...
func (p *G1Affine) RawBytes() (res [SizeOfG1AffineUncompressed]byte) {
	...
	tmp = p.Y
	tmp.FromMont()
	binary.BigEndian.PutUint64(res[168:176], tmp[0])
	binary.BigEndian.PutUint64(res[160:168], tmp[1])
	binary.BigEndian.PutUint64(res[152:160], tmp[2])
	binary.BigEndian.PutUint64(res[144:152], tmp[3])
	binary.BigEndian.PutUint64(res[136:144], tmp[4])
	binary.BigEndian.PutUint64(res[128:136], tmp[5])
	binary.BigEndian.PutUint64(res[120:128], tmp[6])
	binary.BigEndian.PutUint64(res[112:120], tmp[7])
	binary.BigEndian.PutUint64(res[104:112], tmp[8])
	binary.BigEndian.PutUint64(res[96:104], tmp[9])
	binary.BigEndian.PutUint64(res[88:96], tmp[10])
...
const SizeOfG2AffineCompressed = 88
