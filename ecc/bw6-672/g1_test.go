...
func TestG1AffineEndomorphism(t *testing.T) {
	...
	properties.Property("[BW6-672] check that phi(P) = lambdaGLV * P", prop.ForAll(
	...
	properties.Property("[BW6-672] check that phi^2(P) + phi(P) + P = 0", prop.ForAll(
		func(a fp.Element) bool {
			var p, res, tmp G1Jac
			g := MapToCurveG1Svdw(a)
			p.FromAffine(&g)
...
func TestG1AffineIsOnCurve(t *testing.T) {
	...
	properties.Property("[BW6-672] g1Gen (affine) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
	...
	properties.Property("[BW6-672] g1Gen (Jacobian) should be on the curve", prop.ForAll(
		func(a fp.Element) bool {
...
func TestG1AffineConversions(t *testing.T) {
	...
	properties.Property("[BW6-672] Affine representation should be independent of the Jacobian representative", prop.ForAll(
		func(a fp.Element) bool {
	...
	properties.Property("[BW6-672] Affine representation should be independent of a Extended Jacobian representative", prop.ForAll(
		func(a fp.Element) bool {
			var g g1JacExtended
			g.X.Set(&g1Gen.X)
			g.Y.Set(&g1Gen.Y)
	...
	properties.Property("[BW6-672] Jacobian representation should be the same as the affine representative", prop.ForAll(
		func(a fp.Element) bool {
			var g G1Jac
			var op1 G1Affine
			op1.X.Set(&g1Gen.X)
	...
	properties.Property("[BW6-672] Converting affine symbol for infinity to Jacobian should output correct infinity in Jacobian", prop.ForAll(
		func() bool {
			var g G1Affine
			g.X.SetZero()
			g.Y.SetZero()
	...
	properties.Property("[BW6-672] Converting infinity in extended Jacobian to affine should output infinity symbol in Affine", prop.ForAll(
		func() bool {
			var g G1Affine
	...
	properties.Property("[BW6-672] Converting infinity in extended Jacobian to Jacobian should output infinity in Jacobian", prop.ForAll(
		func() bool {
			var g G1Jac
			var op1 g1JacExtended
	...
	properties.Property("[BW6-672] [Jacobian] Two representatives of the same class should be equal", prop.ForAll(
...
func TestG1AffineOps(t *testing.T) {
	...
	properties.Property("[BW6-672] [Jacobian] Add should call double when having adding the same point", prop.ForAll(
		func(a, b fp.Element) bool {
	...
	properties.Property("[BW6-672] [Jacobian] Adding the opposite of a point to itself should output inf", prop.ForAll(
		func(a, b fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
			fop2 := fuzzJacobianG1Affine(&g1Gen, b)
			fop2.Neg(&fop2)
	...
	properties.Property("[BW6-672] [Jacobian] Adding the inf to a point should not modify the point", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
	...
	properties.Property("[BW6-672] [Jacobian Extended] addMixed (-G) should equal subMixed(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
	...
	properties.Property("[BW6-672] [Jacobian Extended] doubleMixed (-G) should equal doubleNegMixed(G)", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
			var p1, p1Neg G1Affine
			p1.FromJacobian(&fop1)
	...
	properties.Property("[BW6-672] [Jacobian] Addmix the negation to itself should output 0", prop.ForAll(
		func(a fp.Element) bool {
			fop1 := fuzzJacobianG1Affine(&g1Gen, a)
			fop1.Neg(&fop1)
			var op2 G1Affine
	...
	properties.Property("[BW6-672] scalar multiplication (double and add) should depend only on the scalar mod r", prop.ForAll(
	...
	properties.Property("[BW6-672] scalar multiplication (GLV) should depend only on the scalar mod r", prop.ForAll(
		func(s fr.Element) bool {
	...
	properties.Property("[BW6-672] GLV and Double and Add should output the same result", prop.ForAll(
		func(s fr.Element) bool {
...
func TestG1AffineCofactorCleaning(t *testing.T) {
	...
	properties.Property("[BW6-672] Clearing the cofactor of a random point should set it in the r-torsion", prop.ForAll(
		func() bool {
...
func TestG1AffineBatchScalarMultiplication(t *testing.T) {
	...
	properties.Property("[BW6-672] BatchScalarMultiplication should be consistant with individual scalar multiplications", prop.ForAll(
