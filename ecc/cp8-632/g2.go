...
func (p *G2Affine) Frobenius(a *G2Affine) *G2Affine {
	...
	B.A1 = fp.Element{
		9166725283875217982,
		16317157228678567377,
		519379592727668234,
		16693363069381562873,
		3677522012136599216,
		9779421115535617370,
		15499143542169057578,
		2490613038876466723,
		1018355542996144232,
		50744356544164736,
	}
...
// FrobeniusCube
func (p *G2Affine) FrobeniusCube(a *G2Affine) *G2Affine {
	var B fptower.E2
	A := fp.Element{
		5970287765817275737,
		8878302867479338423,
	...
	B.A1 = fp.Element{
		...
		9434615779851155264,
		7741264457143547821,
		15358209648410290705,
		13816195074738815850,
		10779356292691355563,
		5146850291338160585,
		9223483062451590636,
		296111038391335460,
		41813889589938800,
...
// FrobeniusSquare
func (p *g2W12) FrobeniusSquare(a *g2W12) *g2W12 {
	A := fp.Element{
		4530246545864761547,
		9990928692222972105,
		17318008247765365690,
		1957776933610185681,
		813768501780872564,
		11598916191079258836,
		1106061690168436796,
		6516792256830800080,
		6735146946517540904,
		24399046428795980,
	...
	p.x.MulByElement(&p.x, &A)
	p.y.MulByElement(&p.y, &B)
	p.z.Set(&a.z)
	return p
}
