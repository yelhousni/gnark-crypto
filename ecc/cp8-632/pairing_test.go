...
func TestPairing(t *testing.T) {
	...
	properties.Property("[CP8-632] Having the receiver as operand (final expo) should output the same result", prop.ForAll(
		func(a GT) bool {
			b := a
	...
	properties.Property("[CP8-632] Exponentiating FinalExpo(a) to r should output 1", prop.ForAll(
		func(a GT) bool {
			b := FinalExponentiation(&a)
	...
	properties.Property("[CP8-632] MillerLoop of pairs should be equal to the product of MillerLoops", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[CP8-632] PairingCheck", prop.ForAll(
		func(a, b fr.Element) bool {
	...
	properties.Property("[CP8-632] MillerLoop should skip pairs with a point at infinity", prop.ForAll(
		func(a, b fr.Element) bool {
