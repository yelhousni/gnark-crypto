...
TEXT ·neg(SB), NOSPLIT, $0-16
	...
	SUBQ  DX, R10
	MOVQ  R10, 0(R9)
	MOVQ  $0x1f49f2b000000000, R10
	SBBQ  CX, R10
	MOVQ  R10, 8(R9)
	MOVQ  $0x25e48630b5800000, R10
	SBBQ  BX, R10
	MOVQ  R10, 16(R9)
	MOVQ  $0xe95ce40bf8a25700, R10
	SBBQ  SI, R10
	MOVQ  R10, 24(R9)
	MOVQ  $0x084c660572fb575e, R10
	SBBQ  DI, R10
	MOVQ  R10, 32(R9)
...
TEXT ·Butterfly(SB), $48-16
	...
	MOVQ    $0x1f49f2b000000000, BX
	MOVQ    $0x25e48630b5800000, SI
	MOVQ    $0xe95ce40bf8a25700, DI
	MOVQ    $0x084c660572fb575e, R8
	MOVQ    $0x0434e417092cfe75, R9
	CMOVQCC AX, CX
	CMOVQCC AX, BX
	CMOVQCC AX, SI
	CMOVQCC AX, DI
